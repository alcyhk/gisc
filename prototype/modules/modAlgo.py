...
def qcAlgoEqual(circuit):
	...
	#circuit.cswap(algo_equalS,algo_equalC1,qreg_outputCL1)
	#circuit.cswap(algo_equalS,algo_equalC2,qreg_outputCL2)
...
def qcAlgoAdd(circuit):
	...
	#circuit.mcx([algo_addA0,algo_addB0],c0)
